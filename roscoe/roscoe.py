...
Usage:
python projects/roscoe/roscoe.py -t sim_sce -m princeton-nlp/sup-simcse-roberta-base --datasets gsm8k --output-directory xx --dataset-path xx
python projects/roscoe/roscoe.py -t sim_sce -m facebook/roscoe-512-roberta-base --datasets gsm8k
python projects/roscoe/roscoe.py --datasets gsm8k --output-directory xx --dataset-path xx
...
DEFAULT_INPUT_PATH = f"./projects/roscoe/MATH/clean/Qwen3B/"
DEFAULT_OUTPUT_PATH = f".projects/roscoe/MATH/clean/Qwen3B/"

# DEFAULT_INPUT_PATH = f"./projects/roscoe/MATH/generated/"
# DEFAULT_OUTPUT_PATH = f"./projects/roscoe/MATH/scores/"



DATASETS = ["drop", "esnli", "cosmos", "gsm8k", "semeval","math500", "amc23", "aime24"]
    ...
    def update_evaluator(self, in_file: str):
        ...
        with open(in_file) as _f:
            for line in _f:
                ...
                if "gsm8k" in in_file or "amc23" in in_file or "math500" in in_file or "aime24" in in_file:
    ...
    for root, _dirnames, filenames in os.walk(opt['dataset_path']):
        for filename in filenames:
            ...
            if os.path.exists(out_p):
                ...
                score_types = (
                    REASONING_SCORES
                    if "esnli" in filename or "gsm8k" in filename or "amc23" in filename or "math500" in filename or "aime24" in filename
