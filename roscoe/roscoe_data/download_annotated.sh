...
rm -rf drop_dataset
# Cosmos QA
wget https://hk.gh-proxy.com/https://github.com/wilburOne/cosmosqa/raw/master/data/valid.csv
mv valid.csv ${PATH_TO_DATA}/raw/cosmos.txt
# e-SNLI
wget https://hk.gh-proxy.com/https://github.com/OanaMariaCamburu/e-SNLI/raw/master/dataset/esnli_dev.csv
...
# GSM8K
wget https://hk.gh-proxy.com/https://github.com/openai/grade-school-math/raw/master/grade_school_math/data/example_model_solutions.jsonl
